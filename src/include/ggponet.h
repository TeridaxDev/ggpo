...
#define GGPO_SPECTATOR_INPUT_INTERVAL     4
     ...
     *
     * u.remote.connection_id: the id of the connection the player is connected on.
     *       This connection id is resolved via the ConnectionManager.
     *
     */
...
#define GGPO_INVALID_HANDLE      (-1)
    ...
    GGPO_API int __cdecl ggpo_add_connection_steam(SteamConnection* steam, int steamID);
